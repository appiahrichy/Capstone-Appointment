...
const services = [
  ...
  { title: "Academic Tutor", image: AcademicImg, path: "/AcademicAdvisorapp" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex justify-around py-2 bg-white shadow-md text-xs md:text-sm">
        <Link to="/dashboard" className={`hover:text-blue-500 ${location.pathname === "/dashboard" ? "text-blue-600 font-bold" : ""}`}>
          Dashboard
        </Link>
